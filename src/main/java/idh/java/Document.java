...
public class Document implements Iterable<String> {
	...
	public void printStats(File f) throws IOException {
		...
		p.printRecord("Anzahl der Wörter", "Anzahl der Types", "Anzahl der Wörter die kürzer sind als 5 Zeichen", "Häufigkeit des Wortes 'blood'", "Das am häufigsten vorkommende Wort",
		...
		// Das am hÃ¤ufigsten vorkommende groÃŸgeschriebene Wort
		// Auch aus der MusterlÃ¶sung Ã¼bernommen; Nur dass '.isUpperCase' benutzt werden muss, war mir klar.
		mft = null;
		frequency = 0;
